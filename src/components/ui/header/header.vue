  ...
  <header class="relative left-0 top-[60px] z-10 w-full">
    <div class="flex justify-between">
      ...
      <ul class="bottom-border hidden items-center gap-4 sm:gap-6 md:gap-8 lg:flex lg:gap-10">
        ...
        <li>
          <router-link class="a cursor-pointer" to="/">Services</router-link>
        </li>
        <li>
          <router-link class="a cursor-pointer" to="/">Use Cases</router-link>
        </li>
        <li>
          <router-link class="a cursor-pointer" to="/">Pricing</router-link>
        </li>
        <li><router-link class="a cursor-pointer" to="/">Blog</router-link></li>
        <div>
